...
router.register(
    "reports/projects", ProjectReportReadOnlyViewSet, basename="project-reports"
)
router.register(
    "reports/expenses", ExpenseReportReadOnlyViewSet, basename="expense-reports"
)
router.register(
    "reports/payrolls", PayrollReportReadOnlyViewSet, basename="payroll-reports"
)
