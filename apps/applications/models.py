...
from .validators import phone_validator, telegram_validator, portfolio_validator
...
class Application(BaseModel):
    ...
    university = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="O'qish joyi va kursi"
    )
    ...
    phone = models.CharField(
        max_length=20, validators=[phone_validator], verbose_name="Telefon raqami"
    )
    ...
    resume = models.FileField(
        ...
        validators=[validate_only_pdf, validate_file_size],
    ...
    portfolio = models.CharField(
        ...
        null=True,
        blank=True,
        validators=[portfolio_validator],
    ...
    reviewed_at = models.DateTimeField(
        null=True, blank=True, verbose_name="Xulosa kiritilgan vaqt"
    )
    ...
    def clean(self):
        ...
        if self.is_student and not self.university:
            errors["university"] = (
                "Talaba bo'lsangiz, o'qish joyingizni kiritishingiz shart."
            )
